...
exec :SQL_ID:= '&1';
select v.sample_time, v.session_id sessid, v.event, v.p1, v.p2, v.current_obj#, v.sql_id, v.sql_exec_start, v.machine, v.program from v$active_session_history v where v.sql_id = :SQL_ID and sample_time > sysdate - 1/48 order by v.sample_time;
